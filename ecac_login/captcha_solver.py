...
PROMPT_COM_REF = (
    ...
    "  IMAGEM 2 — a IMAGEM DE REFERENCIA extraida do cabecalho.\n\n"
    "ATENCAO: O desafio pede 'mesma CATEGORIA' — NAO o mesmo objeto exato.\n"
    "Um aviao e um trem sao da mesma categoria (veiculos/transportes).\n"
    "Um cachorro e um gato sao da mesma categoria (animais).\n\n"
    "TAREFA:\n"
    "1. Observe a IMAGEM 2 e determine a CATEGORIA GERAL do objeto.\n"
    "   Pense em nivel amplo — exemplos de agrupamento correto:\n"
    "     aviao / helicoptero / foguete  →  'veiculos aereos / transportes'\n"
    "     carro / onibus / trem / barco  →  'veiculos / transportes'\n"
    "     cachorro / gato / coelho       →  'animais'\n"
    "     rosa / girassol / tulipa       →  'flores / plantas'\n"
    "     hamburguer / pizza / sushi     →  'alimentos / comida'\n"
    "   Use o mesmo nivel de abstracao que o captcha usa.\n\n"
    "2. Na grade 3x3 da IMAGEM 1, selecione TODOS os tiles cujo objeto pertenca\n"
    "   a essa mesma categoria — mesmo que o objeto seja diferente do da referencia.\n"
    "   Ex.: referencia = aviao → inclua trens, onibus, carros, barcos, outros avioes.\n\n"
    ...
    "  │ 6 │ 7 │ 8 │  (linha inferior)\n"
    "  └───┴───┴───┘\n\n"
    "Seja INCLUSIVO: qualquer angulo, cor, estilo ou recorte parcial — inclua o tile\n"
    "se o objeto pertencer a mesma categoria que a IMAGEM 2.\n\n"
    "Retorne:\n"
    "  task_summary: categoria identificada (ex.: 'veiculos / transportes')\n"
    "  matching_tiles: lista de indices (0-8) dos tiles que pertencem a essa categoria\n"
    "  confidence: 'high' | 'medium' | 'low'"
)
